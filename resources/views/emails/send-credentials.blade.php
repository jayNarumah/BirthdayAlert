		          ...
		          <tr>
		            <td class="bg_light email-section">
		            	<div class="heading-section" style="text-align: center; padding: 0 30px;">
            				...
            				<p style="color: black; font-family:Comic Sans MS;">Congratulations, you that you are now assigned as Admin to the Group <b>{{$details['group_name']}}</b> on Birthday Notification.
